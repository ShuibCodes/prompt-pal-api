...
export interface ApiCriterionCriterion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    subquestions: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiImageQuestionImageQuestion extends Struct.SingleTypeSchema {
  collectionName: 'image_questions';
  info: {
    displayName: 'Image Question';
    pluralName: 'image-questions';
    singularName: 'image-question';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::image-question.image-question'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSubquestionSubquestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    criterion: Schema.Attribute.Relation<
      'manyToOne',
      'api::criterion.criterion'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dailyEmailNotifications: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
